    ...
    return (
        <>
            <div className="space-y-1">
                ...
                <div {...getRootProps({
                    className: `
            py-20 border-2 border-dashed  text-center dark:bg-gray-700 
        ...
        `})}>
            ...
            {image && (
                <div className="py-5 space-y-3">
                    <p className="font-bold dark:text-slate-300">Imagen producto</p>
            ...
            {currentImage && !image && (
                <div className="py-5 space-y-3">
                    <p className="font-bold dark:text-slate-300">Imagen actual</p>
                    <div className="w-[300px] h-[420px] relative">
                        <Image
            ...
            <input type="hidden" defaultValue={image ? image : currentImage} name="image" />
        </>
    )
}
